...
Sailthru.prototype._trackEvents = function(event, track) {
  ...
  var id = track.userId() || track.anonymousId();
...
Sailthru.prototype.orderCompleted = function(track) {
  ...
  var items = mapItems(props.products, productBaseUrl);
  var payload = {
    items: items,
 ...
 *
 * @param {Object} payload - array of products from event.properties.products
