...
Sailthru.prototype.identify = function(identify) {
  ...
  var defaultListName = helpers.getDefaultListName(traits, integrations, options); 
...
Sailthru.prototype.track = function(track) {
  ...
  case 'userSignUpConfirmedOptIn':
    var template = props && props.template || integrations && integrations.Sailthru && integrations.Sailthru.template;
...
/**
 * _addOrRemoveProduct maps to addToCart
 * 
 * @api public
...
/**
 * Takes event name and payload and fires off a Sailthru track event depending on payload
 * 
 * @api public
...
/**
 * Takes event name and payload and fires off a Sailthru integration event
 * 
 * @api public
