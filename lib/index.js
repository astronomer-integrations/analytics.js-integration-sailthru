...
Sailthru.prototype.orderCompleted = function(track) {
  ...
  var sendTemplate = props && props.sendTemplate
    ...
    || options && options.sendTemplate;  var productBaseUrl = context && context.page && context.page.url || options && options.productBaseUrl;
...
function flattenProperties(ob) {
  ...
  for (var i in ob) {
    ...
    if (typeof ob[i] === 'object' && ob[i] !== null) {
      var flatObject = flattenProperties(ob[i]);
