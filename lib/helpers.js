...
exports.getDefaultListName = function(traits, integrations, options) {
  return traits && traits.defaultListName
...
/**
 * Retrieves value for an completed purchase send template
 * 
 * @param {Object} props - event properties
 * @param {Object} integrations - event integration settings
 * @param {Object} options - event options
